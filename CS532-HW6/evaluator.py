...
def compile_daphne():
    for i in range(1, 5):
        file = '../CS532-HW6/programs/{}.daphne'.format(i)
        exp = daphne(['desugar-hoppl-cps', '-i', file])
        with open('../CS532-HW6/programs/{}.json'.format(i), 'w') as f:
            json.dump(exp, f)
